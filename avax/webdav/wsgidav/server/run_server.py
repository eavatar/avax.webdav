...
from avax.webdav.wsgidav.wsgidav_app import DEFAULT_CONFIG
from avax.webdav.wsgidav.xml_tools import useLxml

try:
    from avax.webdav.wsgidav.version import __version__
    from avax.webdav.wsgidav.wsgidav_app import WsgiDAVApp
